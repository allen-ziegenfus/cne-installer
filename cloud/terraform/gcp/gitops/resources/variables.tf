  ...
  type = object(
    {
      ...
      image_url  = optional(string, "oci://us-central1-docker.pkg.dev/gcp-liferay/liferay-gcp-registry/liferay-gcp")
  ...
  type = object(
    {
      ...
      image_url  = optional(string, "oci://us-central1-docker.pkg.dev/gcp-liferay/liferay-gcp-registry/liferay-gcp-infrastructure")
      version    = optional(string, "0.1.5")
      path       = optional(string)
  })
}
  ...
  type = object(
    {
      ...
      image_url  = optional(string, "oci://us-central1-docker.pkg.dev/gcp-liferay/gcp-liferay/liferay-gcp-registry/liferay-gcp-infrastructure-provider")
      version    = optional(string, "0.1.5")
      path       = optional(string)
  })
}
